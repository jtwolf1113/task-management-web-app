...
class User(db.Model, UserMixin):
    ...
    #navbar_highlight_color = db.column(db.string(7))
    #navbar_background_color = db.column(db.string(7))
    #button_text_color = db.column(db.string(7))
    #confirm_button_color = db.column(db.string(7))
    #delete_button_color = db.column(db.string(7))
    #cancel_button_color = db.column(db.string(7))
    #delete-screen-filter = db.column(db.string(7))
